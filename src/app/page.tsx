        ...
        {popUps.map((isPopUpVisible, index) =>
          isPopUpVisible ? (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed left-0 top-0 z-50 flex h-screen w-screen items-center justify-center bg-transparent bg-opacity-30"
            >
              <div className="flex h-56 w-56 flex-col items-center justify-center gap-y-4 rounded-lg bg-white shadow-lg">
